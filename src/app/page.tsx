...
export default function Home() {
  ...
  return (
    <div className="flex sm:gap-80 pt-12 flex-col gap-5 sm:flex-row">
      ...
      <div className="flex sm:gap-10 justify-self-end gap-2">
        {countriesData.map((country) => (
          <Link key={country.id} className="rounded relative group" href={`/countries/${country.slug}`}>
            <Image src={country.coverImg} alt='country cover photo' className="w-64 h-70 rounded cursor-pointer hover:opacity-20" />
            <div
